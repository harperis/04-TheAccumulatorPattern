...
def run_test_count_cosines_from():
    ...
    print('actual', answer)
    expected = 3
    answer = count_cosines_from(7, 12, .23)
    print('Test 3 expected:', expected)
    print('actual', answer)
    expected = 5
    answer = count_cosines_from(10, 30, .35)
    print('Test 4 expected:', expected)
    print('actual', answer)
    expected = 2
    answer = count_cosines_from(0, 4, .32)
    print('Test 5 expected:', expected)
    print('actual', answer)
    expected = 2
    answer = count_cosines_from(5, 11, .21)
